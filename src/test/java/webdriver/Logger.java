...
public final class Logger {
	...
	private static final String LIPTON_LOCALE = "lipton.locale";
	...
	private static PropertiesResourceManager localManager = new PropertiesResourceManager(String.format("localization/loc_%1$s.properties", System.getProperty(LIPTON_LOCALE, DEF_LOCALE.toString()).toLowerCase()));
